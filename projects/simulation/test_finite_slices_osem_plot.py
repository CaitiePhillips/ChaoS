...
angles, subsetsAngles, lengths = mojette.angleSubSets_Symmetric(s,subsetsMode,N,N,1,True,K, prime_only=False, max_angles=20, norm=elNorm(2))
...
rcbar3 = plt.colorbar(rax3, cmap='gray', orientation="horizontal")
